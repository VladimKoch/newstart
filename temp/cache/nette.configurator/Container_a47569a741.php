...
class Container_a47569a741 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Components\NewsletterComponent' => [['013']],
		...
		'App\Factory\NewsletterComponentFactory' => [['014']],
		'App\MyApi\v1\Handlers\UsersRepository' => [['015']],
		'App\Service\MailerFactory' => [['016']],
	];
	...
	{
		return new App\MyApi\v1\Handlers\UsersListingHandler($this->getService('015'));
	}
	...
	public function createService013(): App\Components\NewsletterComponent
	{
		return new App\Components\NewsletterComponent($this->getService('012'), $this->getService('latte.templateFactory'));
	}


	public function createService014(): App\Factory\NewsletterComponentFactory
	{
		return new class ($this) implements App\Factory\NewsletterComponentFactory {
			...
			public function create(): App\Components\NewsletterComponent
			{
				return new App\Components\NewsletterComponent($this->container->getService('012'), $this->container->getService('latte.templateFactory'));
			}
		};
	}


	public function createService015(): App\MyApi\v1\Handlers\UsersRepository
	{
		return new App\MyApi\v1\Handlers\UsersRepository($this->getService('database.default.explorer'));
	}


	public function createService016(): App\Service\MailerFactory
	{
		return new App\Service\MailerFactory;
	}
	...
	{
		$service = new App\Presentation\Mailer\MailerPresenter($this->getService('013'), $this->getService('012'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),

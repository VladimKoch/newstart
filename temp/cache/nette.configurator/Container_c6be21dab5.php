<?php
// source: C:\xampp\htdocs\newstart/config/common.neon
// source: C:\xampp\htdocs\newstart/config/services.neon
// source: array
...
class Container_c6be21dab5 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\MyApi\v1\Forms\ImgForm' => [['08']],
		'App\Model\ImageUploadFormFactory' => [['09']],
		'App\Model\MailSender' => [['010']],
		...
		'App\MyApi\v1\Handlers\UsersRepository' => [['011']],
	];
	...
	{
		return new App\MyApi\v1\Handlers\UsersListingHandler($this->getService('011'));
	}


	public function createService08(): App\MyApi\v1\Forms\ImgForm
	{
		return new App\MyApi\v1\Forms\ImgForm;
	}


	public function createService09(): App\Model\ImageUploadFormFactory
	{
		return new App\Model\ImageUploadFormFactory;
	}


	public function createService010(): App\Model\MailSender
	{
	...
	public function createService011(): App\MyApi\v1\Handlers\UsersRepository
	{
	...
	{
		$service = new App\Presentation\Tomaj\TomajPresenter($this->getService('07'), $this->getService('08'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	{
		$service = new App\Presentation\ImgApi\ImgApiPresenter($this->getService('09'), $this);
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	{
		$service = new App\Presentation\Mailer\MailerPresenter(
			$this->getService('application.linkGenerator'),
			$this->getService('latte.templateFactory'),
			$this->getService('database.default.explorer'),
			$this->getService('010'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\newstart/temp/cache/nette.application/touch',
		));
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=newstart', /*sensitive{*/'root'/*}*/, null, []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_c6be21dab5 $container,
			) {
			}
	...
	{
		return [
			'uploadDirImg' => 'C:\xampp\htdocs\newstart\www\uploads\img',
			'uploadDirPng' => 'C:\xampp\htdocs\newstart\www\uploads\png',

...
/** source: C:\xampp\htdocs\newstart\app\Presentation\Home/show.latte */
final class Template_430b8492b9 extends Latte\Runtime\Template
{
  ...
  <main class="my-5">
    <div class="container">
      ...
      <div class="row">
		...
		echo '">Přihlaš se na údálost</a>
                <a type="button" class="btn btn-secondary shadow" href="';
...
';
		if ($user->isLoggedIn()) /* line 77 */ {
			...
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Home:new', [$posts->id])) /* line 78 */;
			echo '"

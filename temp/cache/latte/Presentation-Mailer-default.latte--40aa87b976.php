...
/** source: C:\xampp\htdocs\newstart\app\Presentation\Mailer/default.latte */
final class Template_40aa87b976 extends Latte\Runtime\Template
{
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mt-5 mb-5">
                <div class="card-body">
                    <h2 class="text-center">Vytvoření Newsletteru</h2>
